...
class igApi {
    ...
    constructor(session_id = '', storeCookie = true) {
        ...
        this.getIdByUsername = (username) => __awaiter(this, void 0, void 0, function* () {
            const res = yield this.FetchIGAPI(config_1.config.instagram_base_url, `/${username}/?__a=1`, config_1.config.iPhone);
        ...
        this.fetchPost = (url) => __awaiter(this, void 0, void 0, function* () {
            ...
            //const req = (await IGFetchDesktop.get(`/${post.type}/${post.shortcode}/?__a=1`))
            const res = yield this.FetchIGAPI(config_1.config.instagram_base_url, `/${post.type}/${post.shortcode}/?__a=1`, config_1.config.desktop);
        ...
        this.fetchUserV2 = (username) => __awaiter(this, void 0, void 0, function* () {
            const res = yield this.FetchIGAPI(config_1.config.instagram_base_url, `/${username}/?__a=1`);
            const { graphql } = res === null || res === void 0 ? void 0 : res.data;
            return graphql.user;
        });
        /**
        ...
        this.fetchUserPosts = (username, end_cursor = '') => __awaiter(this, void 0, void 0, function* () {
            ...
            return (_b = res === null || res === void 0 ? void 0 : res.data) === null || _b === void 0 ? void 0 : _b.data.user.edge_owner_to_timeline_media;
        });
